...
<div class="flex flex-col items-center min-h-screen bg-white dark:bg-[#181f2a] py-0 relative">
    ...
    <div class="w-full max-w-xl p-6 flex flex-col gap-6">
        ...
        <div class="w-full max-w-xl bg-gray-100 dark:bg-gray-800 rounded-3xl shadow-lg p-6 mb-6 flex flex-col gap-4">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left font-jost">
                    ...
                    <tbody>
                        <tr class="border-b border-blue-900 hover:bg-blue-100 dark:hover:bg-blue-950/30 transition">
                            <td class="py-2 px-2 align-top font-bold text-blue-300">001</td>
                            <td class="py-2 px-2">
                                <div class="font-semibold text-blue-900 dark:text-white">Achoc Toddy 200g</div>
        ...
        <div class="w-full max-w-xl flex items-center justify-between bg-blue-800 dark:bg-blue-900 px-8 py-6 rounded-3xl shadow-lg mb-8">
            ...
            <span class="bg-gray-100 dark:bg-gray-800 rounded-3xl w-60 px-6 py-2 text-blue-900 dark:text-white text-3xl font-bold font-jost flex justify-end shadow">{{ number_format(42.71, 2, ',', '.') }}</span>
        </div>
